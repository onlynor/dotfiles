...
;;; Dired — -h gives sizes in K/M/G (including the "total" line), and
;;; `separate' puts that total on its own line under the directory name
;;; instead of appending free space after the directory name.
